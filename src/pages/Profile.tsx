  ...
  return (
    <motion.div initial={pageTransition.initial} animate={pageTransition.animate} exit={pageTransition.exit} transition={pageTransitionConfig} className="h-full">
        ...
        <Card className="rounded-2xl border-2">
          <CardContent className="pt-6">
            ...
            <div className="mt-3 bg-muted/50 rounded-xl overflow-hidden">
              <button
                type="button"
                onClick={() => setIsDistanceExpanded((v) => !v)}
                className="w-full p-4 flex items-center gap-3 text-left"
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  ...
                  <ChevronDown
                    className={`h-5 w-5 text-muted-foreground transition-transform duration-200 ${isDistanceExpanded ? 'rotate-180' : ''}`}
                  />
                </div>
              </button>
              {isDistanceExpanded && (
      ...
      <button
        ...
        className="fixed bottom-24 right-4 z-50 h-14 w-14 rounded-full bg-[#25D366] text-white shadow-lg hover:scale-110 transition-all duration-200 flex items-center justify-center"
