...
const DeliveryTimer = ({ 
  ...
  if (deliveryType === 'scheduled') {
    ...
    return (
      <Card className={`bg-gradient-to-r from-blue-500/10 to-purple-500/10 border-blue-500/30 shadow-lg ${className}`}>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Your order will arrive at</p>
              </div>
            </div>
            ...
            <div className="mt-4 p-3 bg-blue-500/10 rounded-lg border border-blue-500/20">
              <div className="flex items-center justify-center space-x-4">
                <div className="text-center">
                  <p className="text-2xl font-bold text-blue-400">{scheduleInfo.time}</p>
  ...
  return (
    <Card className={`bg-gradient-to-r from-green-500/10 to-emerald-500/10 border-green-500/30 shadow-lg ${className}`}>
      <CardContent className="p-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h3 className="font-semibold text-foreground">Delivery Timer</h3>
              <p className="text-sm text-muted-foreground">Your order will arrive within</p>
            </div>
          </div>
          <Badge className={`${
