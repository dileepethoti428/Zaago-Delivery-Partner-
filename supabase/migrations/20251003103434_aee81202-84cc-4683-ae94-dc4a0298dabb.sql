-- Force drop ALL versions of qr_complete_delivery_atomic to fix ambiguity
...
-- Recreate with clean 6-parameter signature (3 required, 3 optional with defaults)
...
COMMENT ON FUNCTION qr_complete_delivery_atomic IS 'Atomically completes delivery with idempotency. Can be called with 3 or 6 parameters using defaults.';