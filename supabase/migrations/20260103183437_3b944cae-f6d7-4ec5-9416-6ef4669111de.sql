-- Update complete_delivery_zepto to handle unique_violation as success (idempotent)
-- Fixes: duplicate key value violates unique constraint "unique_order_delivery"
...
BEGIN
  ...
  -- Check for idempotency (already completed)
...
EXCEPTION 
  WHEN unique_violation THEN
    -- Race condition: concurrent request already completed - return success (Zepto-style)
    SELECT delivery_payout, distance_traveled 
    INTO v_payout, v_distance
    FROM delivery_history 
