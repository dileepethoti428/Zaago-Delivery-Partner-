-- Fix delivery_address type: text → jsonb in all 3 agent order RPCs
...
RETURNS TABLE(
  order_id uuid, order_date date, quantity numeric, order_status text,
  ...
  is_on_vacation boolean, seller_latitude double precision, seller_longitude double precision
)
