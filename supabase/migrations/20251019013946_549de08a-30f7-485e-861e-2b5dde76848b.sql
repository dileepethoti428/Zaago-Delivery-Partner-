-- Add conflict handling to wallet transactions in safe_complete_delivery
...
BEGIN
  ...
  -- Create delivery history record with correct conflict handling
  ...
  -- Create wallet transaction with conflict handling for idempotency
  ...
  ON CONFLICT (agent_id, order_id) WHERE transaction_type = 'delivery_payment' DO NOTHING;
