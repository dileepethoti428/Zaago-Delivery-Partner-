-- Recreate qr_complete_delivery_atomic to ensure it recognizes existing constraints
...
BEGIN
  ...
  -- 2. Create earnings record (idempotent) - constraint NOW exists
  ...
  -- 3. Update agent wallet - constraint exists on agent_id
...
INSERT INTO password_reset_logs (
  ...
  'email_sent',
  jsonb_build_object(
    'action', 'function_recreated',
    'function_name', 'qr_complete_delivery_atomic',
    'reason', 'Ensure function recognizes existing unique constraints',
    'created_at', now()
  )
);