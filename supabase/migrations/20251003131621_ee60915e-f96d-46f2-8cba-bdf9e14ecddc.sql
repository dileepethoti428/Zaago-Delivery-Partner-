-- Fix column name mismatch in qr_complete_delivery_v3
...
COMMENT ON FUNCTION qr_complete_delivery_v3 IS 'Complete QR delivery with bulletproof idempotency - FIXED: uses v_order.address instead of v_order.delivery_address';