...
-- Recreate WITHOUT explicit completed_at
...
BEGIN
  ...
  SELECT delivery_address INTO v_delivery_address FROM orders WHERE id = v_order_id;

  -- ✅ FIX: Remove completed_at from column list AND VALUES - let DEFAULT now() handle it
