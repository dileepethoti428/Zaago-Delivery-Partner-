-- =====================================================
-- FIX: Drop ALL overloads and recreate clean functions
-- Root cause: Multiple function overloads with wrong column references
-- =====================================================

-- Drop ALL existing overloads of simple_mark_delivered
DROP FUNCTION IF EXISTS simple_mark_delivered(uuid, uuid) CASCADE;
DROP FUNCTION IF EXISTS simple_mark_delivered(uuid, uuid, text) CASCADE;

-- Drop ALL existing overloads of manual_complete_delivery
DROP FUNCTION IF EXISTS manual_complete_delivery(uuid, uuid, text) CASCADE;
DROP FUNCTION IF EXISTS manual_complete_delivery(uuid, uuid) CASCADE;

-- Drop ALL existing overloads of qr_complete_delivery_v3
DROP FUNCTION IF EXISTS qr_complete_delivery_v3(uuid, text, uuid) CASCADE;
DROP FUNCTION IF EXISTS qr_complete_delivery_v3(uuid, uuid, text) CASCADE;
DROP FUNCTION IF EXISTS qr_complete_delivery_v3(text, uuid, text) CASCADE;
DROP FUNCTION IF EXISTS qr_complete_delivery_v3(uuid, uuid, text, text) CASCADE;

-- =====================================================
-- CREATE: simple_mark_delivered (single clean version)
-- =====================================================
...
-- =====================================================
-- CREATE: manual_complete_delivery (single clean version)
-- =====================================================
...
-- =====================================================
-- CREATE: qr_complete_delivery_v3 (single clean version)
-- =====================================================
