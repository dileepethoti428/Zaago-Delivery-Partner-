...
-- 1. Create manual_complete_delivery without order_status column
...
-- 2. Create qr_complete_delivery_v3 without order_status column
...
-- 3. Create simple_mark_delivered with p_payment_method parameter
