...
-- Drop and recreate the trigger function with proper pg_net signature
...
BEGIN
  ...
  IF NEW.status = 'pending' THEN
    ...
    -- Capture the request ID for tracking
    -- Correct pg_net.http_post signature: url, params, headers, body, timeout
    BEGIN
