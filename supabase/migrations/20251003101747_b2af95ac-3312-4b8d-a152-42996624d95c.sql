-- Fix create_delivery_history_entry to use correct orders table fields
...
BEGIN
  -- Derive payment_method from payment_status since orders table doesn't have payment_method
  ...
  INSERT INTO delivery_history (
    ...
    NEW.customer_name,
    NEW.customer_phone,
    NEW.address,  -- Fixed: use NEW.address not NEW.delivery_address
    NEW.items,
    NEW.total,
    v_payment_method,  -- Fixed: derive from payment_status
    NEW.payment_status,
    CURRENT_DATE,
