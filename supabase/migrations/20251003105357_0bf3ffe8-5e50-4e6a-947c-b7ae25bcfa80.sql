-- Fix QR delivery completion by adding missing delivery history logic
...
BEGIN
  ...
  -- 5. Create delivery history record (idempotent - CRITICAL FIX)
...
COMMENT ON FUNCTION qr_complete_delivery_v2 IS 'Complete QR delivery with full business logic including delivery_history insertion with idempotency';